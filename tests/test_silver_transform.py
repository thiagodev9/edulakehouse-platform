...
def test_transform_output_columns(spark, bronze_schema, sample_bronze_data):
...
def test_transform_preserves_record_count(spark, bronze_schema, sample_bronze_data):
    from pipelines.silver.ibge_silver_pipeline import IBGESilverPipeline
...
def test_transform_municipio_id_correct(spark, bronze_schema, sample_bronze_data):
    from pipelines.silver.ibge_silver_pipeline import IBGESilverPipeline
...
def test_transform_uf_sigla_correct(spark, bronze_schema, sample_bronze_data):
    from pipelines.silver.ibge_silver_pipeline import IBGESilverPipeline
...
def test_transform_regiao_nome_correct(spark, bronze_schema, sample_bronze_data):
    from pipelines.silver.ibge_silver_pipeline import IBGESilverPipeline
...
def test_transform_no_nulls_in_key_columns(spark, bronze_schema, sample_bronze_data):
